...
const short STANDARD_SHIPS_WIDTH[] = { 1, 2, 3, 4 };
const short STANDARD_SHIPS_HEIGHT[] = { 1, 1, 1, 1};
const short STANDARD_SHIPS_ATTACK_RADIUS[] = { 1, 1, 1, 1 };
const short STANDARD_SHIPS_NUMBER[] = { 4, 3, 2, 1 };
